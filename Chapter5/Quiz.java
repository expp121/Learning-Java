...
class Quiz{
    ...
    public static void main(String Args[])
    {
        ...
        String[][] answers = {{"Bangladesh", "Varna", "Sofia"},
                                ...
                                {"Sucking dicks", "Coding", "Playing Scribbl"},
                                {"Earth", "Mars", "Jupiter"},
                                {"Da", "Ne", "Ne znam"}
                            };

        String[] question = {"What is the capital of Bulgraia?:", 
                                "What was the most popular song in 2012?:", 
                                "What's Miksera's hobby?: ", 
                                "What's the third planet from our solar system?: ",
        ...
        System.out.println("You made " + incorrectAnswers + " mistakes\nAnd answered correctly " + correctAnswers + " question!");
